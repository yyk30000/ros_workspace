...
class BEVTransform:
    def __init__(self, params_cam, xb=1.0, zb=1.0):
        ...
        if params_cam["ENGINE"]=="UNITY" :
            ...
            self.alpha_c = np.deg2rand(params_cam["FOV"]/2)
    ...
    def project_pts2img(self, xyz_brid) :
...
class CURVEfit:
    ...
    def write_path_msg(self, x_pred, y_pred_l, y_pred_r):
        ...
        self.lane_path.header.frame.id='/map'
...
class purePursuit:
    ...
    def steering_angle(self):
        ...
        if self.is_look_forward_point:
            steering_deg=math.atan2((2*self.vehicle_lenght*math.sin(theta)), self.ifd)*180/math.pi
