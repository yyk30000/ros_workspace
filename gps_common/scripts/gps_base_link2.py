...
#         self.pre_x=self.odom_msg.pose.pose.position.x
#         self.pre_y=self.odom_msg.pose.pose.position.y
#         self.prev_theta=0
#         self.theta=0
#         self.quaternion =0
...
#                 dx =self.x-self.pre_x
#                 dy =self.y-self.pre_y
...
#        _,_,self.theta=euler_from_quaternion(odom_quaternion)
#        self.quaternion =odom_quaternion
